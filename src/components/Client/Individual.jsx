...
const Individual = ({ client }) => {
    ...
    // }
    return (
        <div className="w-full hover:bg-violet-100 h-[100%] justify-center  flex items-center text-white   border-b-0  border rounded-t-xl border-indigo-700 flex-col  ">
            ...
            <div className="w-full h-[40%] flex flex-col gap-1 justify-start items-center p-2 bg-violet-600 bg-opacity-75">
